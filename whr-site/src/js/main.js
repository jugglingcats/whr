WHR = (function ($) {
	...
	if (!Modernizr.touch) {
        ...
        slides.forEach(function (slide, index) {
            ...
            new ScrollMagic.Scene({triggerElement: slide, triggerHook: 1, duration: "100%"})
        ...
        introTl
            .to($('#intro header, .scroll-hint'), 2, {autoAlpha: 0, ease: Power1.easeNone})
        ...
        //     .set($('#slide01 h1'), {text: 'Bathroom / WC'})
        //     .set($('#slide01 p'), {text: "Upstairs bathroom with bath, shower and WC. Downstairs&nbsp;WC"})
